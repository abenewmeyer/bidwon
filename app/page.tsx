...
const TESTIMONIALS = [
  {
    quote:
      "We won a $4.2M IDIQ on the first AI-drafted proposal BidWon wrote for us. We'd been losing for three years before that.",
    name: "Sarah M.",
    title: "VP Capture",
    company: "ClearPath Federal Solutions",
    stars: 5,
    result: "$4.2M IDIQ won",
  },
  {
    quote:
      "BidWon found an opportunity we would have completely missed — it was posted 48 hours before the deadline. We submitted, we won. $1.7M contract.",
    name: "Marcus T.",
    title: "Owner",
    company: "Trident Infrastructure Group",
    stars: 5,
    result: "$1.7M contract",
  },
  {
    quote:
      "We replaced our $115k/yr BD coordinator with BidWon Strategic. Our pipeline went from 8 bids/year to 25. Win rate is up 40%.",
    name: "Denise R.",
    title: "CEO",
    company: "Apex Consulting Partners (HUBZone)",
    stars: 5,
    result: "40% win rate increase",
  },
];
...
const FAQS = [
  {
    q: "How does BidWon access SAM.gov data?",
    a: "BidWon syncs directly with the SAM.gov public API and refreshes daily. All data is pulled from official government sources — no scraping, no delays.",
  },
  {
    q: "Is my company's data and strategy kept private?",
    a: "Absolutely. Your NAICS targeting, past performance data, and bid strategy are stored in your Private Vector Vault and are never shared with other users or competitors.",
  },
  {
    q: "Do I need a BD team to use BidWon?",
    a: "No. BidWon is built specifically for lean teams and owner-operators who don't have a full BD function. Most customers run BidWon as their entire capture operation.",
  },
  {
    q: "How long does AI bid drafting take?",
    a: "Most bids are drafted in 2–4 hours after you confirm the opportunity. Complex technical proposals (R&D, engineering) may take up to 24 hours.",
  },
  {
    q: "What NAICS codes and set-asides do you support?",
    a: "BidWon supports all NAICS codes in the SAM.gov system and filters by all major set-asides: 8(a), HUBZone, SDVOSB, WOSB, SB, and unrestricted.",
  },
  {
    q: "Can I upgrade or downgrade my plan?",
    a: "Yes. You can upgrade at any time and the prorated difference is applied immediately. Downgrades take effect at the next renewal date.",
  },
  {
    q: "Is BidWon's AI compliant with federal proposal requirements?",
    a: "BidWon's drafting engine is trained on FAR, DFARS, and agency-specific solicitation requirements. Our customers report a 94% average compliance score on AI-drafted submissions.",
  },
  {
    q: "What if I don't win any contracts in year one?",
    a: "If you purchase an annual plan and don't win a contract in your first 12 months, we extend your subscription for free — for as long as it takes. We've never had to honor it more than once.",
  },
];
...
const TIERS = [
  ...
  },
  {
    ...
    href: "https://calendly.com/bidwon/strategy", // replace with real link
  },
];
    ...
    <section className="py-28 px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <h2 className="text-4xl font-black text-center text-white mb-4">
          From SAM.gov to Signed Contract
        </h2>
        <p className="text-slate-400 text-center max-w-xl mx-auto mb-16">
          Three steps. No BD team required. Most customers submit their first AI-drafted bid within 48 hours of signing up.
        </p>
        <div className="grid md:grid-cols-3 gap-8">
          {STEPS.map((step) => {
            ...
            return (
              <div
                key={step.number}
                className="relative bg-slate-900/60 border border-slate-800 rounded-2xl p-8 hover:border-emerald-500/40 transition-colors duration-300"
              >
    ...
    <section className="py-20 px-6 bg-slate-900/30">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="text-4xl font-black text-white mb-6">
          Most Contractors Bid Blind — and Lose Because of It
        </h2>
        <p className="text-slate-300 text-lg leading-relaxed mb-6">
          The average small contractor spends 60+ hours a month chasing solicitations they were never going to win. Your team is exhausted reviewing thousands of SAM.gov postings. Your proposals are technically sound but written in weeks, not hours. And every missed deadline is a contract your competitor just picked up.
        </p>
    ...
    <section className="py-28 px-6 bg-slate-900/20">
      <div className="mx-auto max-w-5xl">
        ...
        <h2 className="text-4xl font-black text-white text-center mb-16">
          Real Contractors. Real Contract Wins.
        </h2>
        <div className="grid md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.name}
              className="bg-slate-900 border border-slate-800 rounded-2xl p-8 flex flex-col hover:border-emerald-500/30 transition-colors duration-300"
            >
...
function ComparisonTable() {
  return (
    <section className="py-28 px-6">
      <div className="mx-auto max-w-5xl">
        <p className="text-emerald-400 text-xs uppercase tracking-[0.2em] font-bold text-center mb-3">
          Is BidWon Worth It?
        </p>
            ...
            <thead>
              <tr>
                ...
                <th className="text-center pb-4 px-3">
                  <div className="bg-emerald-500 text-white font-black text-xs px-3 py-2 rounded-xl inline-block mb-1">BidWon</div>
                </th>
                <th className="text-center pb-4 px-3">
  ...
  return (
    <section id="pricing" className="py-28 px-6 bg-slate-900/20">
      <div className="mx-auto max-w-5xl">
        ...
        <h2 className="text-4xl font-black text-white text-center mb-4">
          Choose Your Acquisition Tier
        </h2>
        <p className="text-slate-400 text-center max-w-xl mx-auto mb-8">
          Every plan includes a <span className="text-white font-semibold">12-month win guarantee</span> on annual billing — or we extend your subscription free.
        </p>
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          ...
          >
            <span
              className={`inline-block h-5 w-5 rounded-full bg-white shadow transition-transform ${isAnnual ? "translate-x-8" : "translate-x-1"}`}
            />
          </button>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {TIERS.map((tier) => {
            ...
            const href = isAnnual ? tier.annualHref : tier.monthlyHref;
            ...
            return (
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  {isAnnual && (
                    <p className="text-slate-500 text-xs mt-1">
                      ${Math.round(price / 12).toLocaleString()}/mo equivalent
                    </p>
                  )}
                </div>
                ...
                {/* Annual guarantee nudge */}
                {!isAnnual && tier.name !== "Sovereign (Enterprise)" && (
                ...
                <a
                  href={tier.name === "Sovereign (Enterprise)" ? (tier.href ?? href) : href}
                  className={`block text-center py-4 rounded-xl font-black text-sm transition-all duration-200 ${
                    tier.popular
                      ? "bg-emerald-500 text-white hover:bg-emerald-400"
                      : tier.name === "Sovereign (Enterprise)"
                      ? "bg-slate-700 text-white hover:bg-slate-600"
                      : "bg-slate-800 text-white hover:bg-slate-700"
                  }`}
                >
                  {tier.name === "Sovereign (Enterprise)" ? "Book a Strategy Call →" : `${tier.cta} →`}
                </a>
              </div>
            );
          })}
      ...
      <div className="mx-auto max-w-3xl text-center">
        <div className="bg-gradient-to-br from-emerald-950 to-slate-900 border border-emerald-500/30 rounded-3xl p-16">
          ...
          <p className="text-slate-400 mb-10 max-w-lg mx-auto">
            Every day you wait, your competitors are scoring opportunities you haven't seen yet. Start your BidWon trial and see exactly which contracts match your NAICS codes — today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#pricing"
              className="bg-emerald-500 hover:bg-emerald-400 text-white font-black px-10 py-4 rounded-xl transition-colors duration-200"
            >
              See My Matched Contracts →
            </a>
            <a
              href="#demo"
              className="border border-slate-700 hover:border-slate-500 text-white font-semibold px-10 py-4 rounded-xl transition-colors duration-200"
            >
              Run the Free Demo
            </a>
          </div>
          <p className="text-slate-500 text-xs mt-6">
            Annual plan • 12-month win guarantee • Cancel anytime
          </p>
        </div>
      </div>
    </section>
  ...
  return (
    <footer className="border-t border-slate-800 py-12 px-6">
      <div className="mx-auto max-w-5xl flex flex-col md:flex-row items-center justify-between gap-6">
        <span className="text-2xl font-bold tracking-tighter bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">
          BidWon.
        </span>
        ...
        opportunities: [
          {
            ...
            score: 93,
            value: "$2.4M–$8.1M IDIQ",
            setAside: "SDVOSB / HUBZone Eligible",
            summary: "Excellent match for your selected NAICS codes. Strong set-aside eligibility.",
            checklist: "Flexible place of performance • Past performance required",
          },
          {
          ...
          {
            title: "Environmental Remediation & Site Assessment Support",
            agency: "Environmental Protection Agency (EPA)",
            deadline: "June 18, 2026",
            score: 81,
            value: "$750K–$2.2M",
            setAside: "8(a) Eligible",
            summary: "Strong match on remediation NAICS. Straightforward technical requirements.",
            checklist: "No prior EPA work required • Streamlined evaluation",
          },
        ],
      });
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans">
      ...
      <nav className="flex items-center justify-between px-6 py-4 lg:px-8 border-b border-slate-800/60 bg-slate-950/80 backdrop-blur-md sticky top-0 z-50">
        ...
        <a
          href="#demo"
          className="bg-emerald-500 hover:bg-emerald-400 text-white text-sm font-black px-5 py-2.5 rounded-lg transition-colors duration-200"
        >
          Run Free Demo →
        </a>
      </nav>
      ...
      <section className="relative px-6 pt-20 pb-16 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-500 text-sm mb-10">
            Used by 340+ federal contractors who've captured $2.1B+ in federal work.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <a
              href="#demo"
              className="bg-emerald-500 hover:bg-emerald-400 text-white font-black px-10 py-4 rounded-xl transition-colors duration-200 text-lg"
            >
              See My Matched Contracts →
            </a>
            <a
              href="#pricing"
              className="border border-slate-700 hover:border-slate-500 text-white font-semibold px-10 py-4 rounded-xl transition-colors duration-200 text-lg"
            >
              View Pricing
            </a>
          </div>
      ...
      <section id="demo" className="py-24 px-6 bg-slate-900/30">
        <div className="mx-auto max-w-3xl">
          ...
          <h2 className="text-4xl font-black text-white text-center mb-4">
            See Your Matched Contracts in 60 Seconds
          </h2>
          <p className="text-slate-400 text-center mb-10">
            Select up to 5 NAICS codes and run a live scan against active SAM.gov opportunities. No signup required.
          </p>
          ...
          <button
            onClick={runDemo}
            disabled={selectedNaics.length === 0 || isDemoRunning}
          ...
          >
            {isDemoRunning ? (
              ...
              <>
                ...
                Run Free Demo — No Signup Required
              </>
            )}
          </button>
          ...
          {demoResults && (
            <div className="mt-10 space-y-4">
              <p className="text-slate-400 text-sm text-center">
                Found <span className="text-white font-bold">{demoResults.opportunities.length} matched opportunities</span> for your selected NAICS codes
              </p>
              {demoResults.opportunities.map((opp, index) => (
                <div key={index} className="relative bg-slate-900 border border-slate-800 p-6 rounded-2xl">
                  {showBlur && index >= 1 && (
                    <div className="absolute inset-0 backdrop-blur-sm bg-slate-950/70 flex flex-col items-center justify-center rounded-2xl gap-4 z-10">
                      <p className="text-white font-bold text-center">
                        {demoResults.opportunities.length - 1} more opportunities found
                      </p>
                      <Link
                        href="#pricing"
                  ...
                  <div className="flex items-start justify-between gap-4 mb-3">
                    ...
                    <div className="flex-shrink-0 text-center">
                      <div className="text-3xl font-black text-emerald-400">{opp.score}</div>
                      <div className="text-slate-500 text-xs">win score</div>
                    </div>
                  </div>

                  <p className="text-slate-400 text-sm mb-1">{opp.agency}</p>
                  <div className="flex flex-wrap gap-3 mt-3 text-xs">
                    <span className="bg-slate-800 text-slate-300 px-3 py-1 rounded-full">📅 {opp.deadline}</span>
                    <span className="bg-slate-800 text-slate-300 px-3 py-1 rounded-full">💰 {opp.value}</span>
                    <span className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-3 py-1 rounded-full">🛡 {opp.setAside}</span>
                  </div>

                  <div className="mt-4 pt-4 border-t border-slate-800 flex gap-4 text-xs text-slate-400">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-slate-950/95 backdrop-blur border-t border-slate-800 px-4 py-3">
        <a
          href="#pricing"
          className="block w-full bg-emerald-500 hover:bg-emerald-400 text-white font-black text-center py-3.5 rounded-xl transition-colors"
        >
          See My Matched Contracts →
        </a>
      </div>
